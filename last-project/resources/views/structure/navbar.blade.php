<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="/">
        <svg width="4em" height="4em" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="viruses"
            class="svg-inline--fa fa-viruses fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 512">
